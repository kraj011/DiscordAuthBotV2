    ...
    return (
      <Layout>
        ...
        <Input
          ...
          id="tokenField"
          onChange={val => this.setState({ token: val })}
        ...
        <Input
          ...
          id="roleToAddField"
          onChange={val => this.setState({ roleToAdd: val })}
        />
        <br />
        <br />
        ...
        <Input
          ...
          onChange={val => this.setState({ roleToRemove: val })}
        />
        <br />
        <br />
        <Button onClick={this.setRoleToRemove}> Save Role To Remove </Button>
      </Layout>
    )
  }
}
